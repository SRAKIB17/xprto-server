CREATE TABLE
    user_documents (
        ...
        uuid CHAR(36) NOT NULL COMMENT 'public uuid',
        user_type ENUM ('client', 'gym', 'trainer', 'admin') NOT NULL COMMENT 'polymorphic owner type',
        user_id BIGINT UNSIGNED NOT NULL COMMENT 'owner id',
        document_type VARCHAR(64) NOT NULL COMMENT 'e.g. Aadhaar Card, PAN Card, Certificate',
        original_name VARCHAR(255) NOT NULL,
        stored_name VARCHAR(255) NOT NULL COMMENT 'filename stored in disk/S3',
        storage_path VARCHAR(1024) NOT NULL COMMENT 'full path or object key',
        mime_type VARCHAR(100) DEFAULT NULL,
        size BIGINT UNSIGNED DEFAULT NULL COMMENT 'bytes',
        metadata JSON DEFAULT NULL COMMENT 'optional extra info',
