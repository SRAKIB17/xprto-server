...
CREATE TABLE
    client_skeletal_muscles (
        skeletal_id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, -- প্রাইমারি কী: প্রতিটি রেকর্ডের ইউনিক আইডি, অটো ইনক্রিমেন্ট হবে
        ...
        CONSTRAINT skeletal_chk_whole_body_percent CHECK (
            whole_body_percent >= 0
            AND whole_body_percent <= 100
        ),
        CONSTRAINT skeletal_chk_trunk_percent CHECK (
        ...
        CONSTRAINT skeletal_chk_arms_percent CHECK (
        ...
        CONSTRAINT skeletal_chk_legs_percent CHECK (
...
```sql
INSERT INTO client_skeletal_muscles 
