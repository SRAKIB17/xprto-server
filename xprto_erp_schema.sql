...
CREATE TABLE
  IF NOT EXISTS verification_badges (
    id BIGINT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
    code ENUM (
      'verified',
      'fully_verified',
...
CREATE TABLE
  IF NOT EXISTS membership_plans (
    id BIGINT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
    gym_id BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE
  IF NOT EXISTS purchase_order_items (
    id BIGINT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE
  IF NOT EXISTS sales_order_items (
    id BIGINT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE
  IF NOT EXISTS coupon_redemptions (
    id BIGINT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE
  IF NOT EXISTS program_workouts (
    id BIGINT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE
  IF NOT EXISTS transformation_records (
    id BIGINT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
    user_id BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE
  IF NOT EXISTS pro_portfolio_items (
    id BIGINT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE
  IF NOT EXISTS pro_service_packages (
    id BIGINT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
    pro_profile_id BIGINT UNSIGNED NOT NULL,
    name VARCHAR(150) NOT NULL,
    description TEXT NULL,
...
CREATE TABLE
  products (
    product_id BIGINT AUTO_INCREMENT PRIMARY KEY, -- ইউনিক প্রোডাক্ট আইডি
    title VARCHAR(255) NOT NULL, -- প্রোডাক্ট নাম
    category VARCHAR(100) DEFAULT NULL, -- ক্যাটাগরি
    subcategory VARCHAR(100) DEFAULT NULL, -- সাবক্যাটাগরি
    brand VARCHAR(100) DEFAULT NULL, -- ব্র্যান্ড
    sku VARCHAR(50) DEFAULT NULL, -- স্টক কিপিং ইউনিট
    price DECIMAL(10, 2) NOT NULL DEFAULT 0.00, -- মূল দাম
    discount DECIMAL(10, 2) DEFAULT 0.00, -- ডিসকাউন্ট
    stock INT DEFAULT 0, -- স্টক সংখ্যা
    rating DECIMAL(3, 2) DEFAULT 0.00, -- রেটিং
    total_reviews INT DEFAULT 0, -- মোট রিভিউ
    status ENUM ('active', 'inactive', 'out_of_stock') DEFAULT 'active', -- প্রোডাক্ট স্ট্যাটাস
    vendor_id BIGINT DEFAULT NULL, -- বিক্রেতা আইডি (Gym Owner/Shop Owner)
